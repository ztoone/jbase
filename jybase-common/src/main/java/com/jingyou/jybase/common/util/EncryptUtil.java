...
import com.jingyou.jybase.common.util.security.BASE64Decoder;
import com.jingyou.jybase.common.util.security.BASE64Encoder;
...
public class EncryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(encrypt("1483944918375"));
        System.out.println(decrypt("DSnlqAaY30BuhMD/c7tFfzxrUJgiZmWwP5+qrmPhxgg="));
    }
}